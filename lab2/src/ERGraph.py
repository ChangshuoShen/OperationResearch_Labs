...
class Graph:
    ...
    Return: 
        a connected ER graph with a weight matrix W for each edge
    ...
    def build_graph(self):
        ...
        # Update peer using adjacency matrix
        self.peer = nx.adjacency_matrix(self.G).toarray()
